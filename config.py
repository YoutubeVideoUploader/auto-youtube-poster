...
GLOBAL_INTRO = "എല്ലാവർക്കും സിനിമാലോകത്തെ പുത്തുപുത്തൻ വാർത്തകളിലേക്ക് സ്വാഗതം"
GLOBAL_OUTRO = "ഇന്നത്തെ മലയാള സിനിമയിലെ പ്രധാന അപ്ഡേറ്റുകൾ ഇത്രയുമാണ്. വീണ്ടും പുതിയ സിനിമാ വാർത്തകളുമായി കാണാം. എല്ലാവർക്കും നന്ദി."
TEST_MODE = False
